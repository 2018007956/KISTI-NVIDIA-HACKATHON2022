...
class Label_Transform(object):
    def __init__(self,label_pixel=(0, 29, 76, 105, 150,179, 226,255)):#(26, 51, 77, 102, 128, 153, 179, 204, 230, 255)):
        self.label_pixel = label_pixel

    def __call__(self, image, label=None, *args): ### missing 'label' argument --> 조건문 만듦
        if label is None:
            return image,
        else:
